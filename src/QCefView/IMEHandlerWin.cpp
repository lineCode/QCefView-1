...
void IMEHandlerWin::GetCompositionInfo(
    HIMC imc,
    LPARAM lparam,
...
bool IMEHandlerWin::GetString(HIMC imc,
                                 WPARAM lparam,
                                 int type,
                                 CefString &result) {
    if (!(lparam & type))
...
bool IMEHandlerWin::GetComposition(
    LPARAM lparam,
    CefString &composition_text,
    std::vector<CefCompositionUnderline> &underlines,
    int &composition_start) {
...
void IMEHandlerWin::ChangeCompositionRange(
